...
<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal<?php echo $row_money['paper_id'] ?>">
  อัพโหลดหลักฐานการชำระเงิน
</button>

<!-- Modal -->
<div class="modal fade" id="myModal<?php echo $row_money['paper_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
