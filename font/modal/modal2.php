...
<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="myModal<?php echo $row['paper_id'] ?>" tabindex="-1" role="dialog"
        ...
        <div class="card">
          ...
          <div class="content">
            ...
            <div class="row">
              ...
              <div class="col col-6-lg ms-auto"><span>
                  <?php echo $row_q_p['paper_id'] ?></span></div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col col-6-lg ms-auto"><span>
                  <?php echo $row_q_p['name_th'] ?></span></div>
            ...
            <div class="row">
              ...
              <div class="col col-6-lg ms-auto"><span>
                  <?php echo $row_status['status'] ?></span>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col col-6-lg ms-auto"><span>
                  <?php echo $row_q_p['abstract'] ?></span>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col col-12-lg ms-auto">
                <h4 style="margin-left:20px"> สถานะผู้ตรวจคนที่
                  <?php echo $i++ ?>
                </h4>
                <p style="margin-left:20px"> ชื่อ :
                  <?php echo $row_RA['first_name'] . " " . $row_RA['last_name'] ?>
                </p>
                <p style="margin-left:20px"> คะแนน :
                  <?php echo $row_RA['score'] ?>
                </p>
                <p style="margin-left:20px"> ผลตรวจ :
                  <?php echo $row_RA['status'] ?>
                </p>
                <p style="margin-left:20px"> คอมเมนต์ :
            ...
            <div>
              ...
              <div class="container">
                <form action="server/update_paper.php?id=<?php echo $row['paper_id'] ?>" method="post" enctype="multipart/form-data">
                  <hr>
                  <h4>ส่งไฟล์แก้ไข</h4>
