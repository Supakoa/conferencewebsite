...
<body id="page-top">
    ...
    <img src="../back/pages/banner/<?php echo $r_3['tmp_name'] ?>" class="img-responsive" alt="" style="width:100%;heigth:auto"
        srcset="">
       <div class="container-fluid" style="background-color:#F6F8FA;">
       <div class="container" id="manual" style="background-color:#F6F8FA;">
            <br><br>
            <div class="alert alert-light alert-dismissible fade show" role="alert">
                 
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="text-center" style="color:#000">เว็บไซต์ที่เกี่ยวข้อง</h3>
                        <ul class="list-inline list-social">
                            <li>
                               
                                    <?php while ($r1 = mysqli_fetch_array($q_a)) { ?>
                                    <a style="color:#e766ff" class="text-center" target="_blank" href="<?php echo $r1['url']; ?>">
                    ...
                    <div class="col-md-6">
                        <h3 class="text-center" style="color:#000">เอกสารที่เผยแพร่</h3>
                        <ul class="list-inline list-social" >
                            <li>
                               
                                    <?php while ($r2 = mysqli_fetch_array($q_b)) { ?>
                                    <a style="color:#e766ff" class="text-center" target="_blank" href="uploads/<?php echo $r2['url'];  ?>">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mx-auto">
                                        ...
                                        <input class="form-control" name="username" type="text" placeholder="Username"
                                            required="required" pattern="([!-~]{6,})" title="ขั้นต่ำ 6 ตัวอักษร เฉพาะภาษาอังกฤษ ตัวเลขหรือสัญญาลักษณ์พิเศษ"
                                    ...
                                    <div class="col-lg-6 mx-auto">
                                        ...
                                        <input class="form-control" name="password" type="password" placeholder="Password"
                                            required="required" pattern="(.{6,})" title="ขั้นต่ำ 6 ตัวอักษร"
                            ...
                            <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                <div class="row">
                                    <div class="col-lg-6 mx-auto">
                                        ...
                                        <input class="form-control" name="fname" type="text" placeholder="ชื่อ"
                                            required="required" pattern="^[ก-๛!-@[-`{-~\s]+$" title="กรุณากรอกเฉพาะภาษาไทย"
                            ...
                            <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 mx-auto">
                                        <h6 style="color:#ffffff">บริษัทในเครือ (You Institute, e.g. "Suan Sunandha
                                            Rajabhat University")</h6>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mx-auto">
                                        ...
                                        <input class="form-control" name="email" type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"
                                            title="ตัวอย่าง examble@email.com" placeholder="Email" required="required"
                                            data-validation-required-message="Please enter your Email.">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="col-lg-6 mx-auto">
                                        <h5 style="color:#ffffff">ยินยัน email ** </h5>
                                        <input class="form-control" name="conemail" type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"
                                            title="ตัวอย่าง examble@email.com" placeholder="ยืนยัน email" required="required"
                                            data-validation-required-message="Please enter your Confirm email.">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="col-lg-12 mx-auto">
                                        <h5 style="color:#ffffff">เบอร์โทรศัพท์มือถือ **</h5>
                                        <input class="form-control" name="tel" type="text" maxlength="10" pattern="[0-9]{10}"
                                            title="ตัวอย่าง 0888888888" placeholder="เบอร์โทรศัพท์มือถือ **" required="required"
                                            data-validation-required-message="Please enter your Phone number.">
                                        <p class="help-block text-danger"></p>
                                    </div>
                                    <div class="col col-lg-12 mx-auto">
                                        <h5 style="color:#ffffff">สมาชิก</h5>
                                        <textarea class="form-control" placeholder="รายชื่อสมาชิก(ถ้ามี)" name="member"
                                            rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
